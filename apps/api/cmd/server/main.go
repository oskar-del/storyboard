...
import (
	...
	"github.com/storyboard/api/internal/invites"
...
func main() {
	...
	v1 := r.Group("/api/v1", authMW)
	{
		...
		// Invites — any authenticated user can invite others
		v1.POST("/invites", invites.Send(database, inviteCfg))
		v1.GET("/invites", invites.List(database))
	}
